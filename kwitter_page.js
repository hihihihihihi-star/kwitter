       ...
       snapshot.forEach(function(childSnapshot)
        { childKey = childSnapshot.key; childData = childSnapshot.val();
             if(childKey != "purpose") { firebase_message_id = childKey;
                 ...
                 console.log(firebace_massage_id);
                 console.log(mesage_data);
                 name=message_data['name'];
                 message=message_data['message'];
                 like=message_data['like'];
                 name_with_tag="<h4>"+name+"<img class='user_tick' src='https://www.jing.fm/clipimg/detail/24-242581_checkmark-svg-clipart-green-tick-png.png'> </h4>";
                 message_with_tag="<h4 class='message_h4'>"+message+"</h4>";
                 like_button="<button class='btn btn-warning' id="+firebace_message_id+" value="+like+" onclick='updateLike(this.id)'>";
